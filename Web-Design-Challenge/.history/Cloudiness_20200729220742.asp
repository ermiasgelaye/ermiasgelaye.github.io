...
<body>
    ...
    <div class="row content">
        <div class="col-sm-12 col-md-8 col-lg-8">
            ...
            <p>This scatter plots, latitude vs cloudiness, does not have a clear trend. Cities would have sunny days as
                much as cloudy days. Distance from the equator to city is less likely to be a factor that influences
                cloudiness.</p>
        </div>
